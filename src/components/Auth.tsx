      ...
      <div className="max-w-md w-full relative z-10">
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl shadow-gray-200/50 p-8 border border-white/50">
          ...
          <p className="text-gray-500 text-sm text-center mb-6">
            Learn Japanese word order by rearranging sentences
          </p>
            ...
            <div>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 bg-gray-50/50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-amber-500/50 focus:border-amber-400 focus:bg-white outline-none transition-all"
                  placeholder="Email"
                  required
                />
              </div>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-3 bg-white text-gray-400 rounded">Or sign in with</span>
            </div>
          </div>
          ...
          <div className="flex justify-center gap-4">
            <button
              ...
              disabled={loading || googleLoading}
              className="w-14 h-14 bg-white hover:bg-gray-50 rounded-xl border border-gray-200 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center shadow-sm hover:shadow-md hover:scale-105 active:scale-95"
